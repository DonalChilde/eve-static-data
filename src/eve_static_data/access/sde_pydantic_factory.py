...
# # TODO use MODEL.from_sde factory methods instead of model_validate
...
#         yield PM.AgentTypes.from_sde(item, metadata)
...
#         yield PM.Ancestries.from_sde(item, metadata)
...
#         yield PM.Bloodlines.from_sde(item, metadata)
...
#         yield PM.Blueprints.from_sde(item, metadata)
...
#         yield PM.Categories.from_sde(item, metadata)
...
#         yield PM.Certificates.from_sde(item, metadata)
...
#     for item, metadata in reader.records(SdeDatasetFiles.CHARACTER_ATTRIBUTES, file_name):
#         yield PM.CharacterAttributes.from_sde(item, metadata)
...
#         yield PM.CloneGrades.from_sde(item, metadata)
...
#         yield PM.CompressibleTypes.from_sde(item, metadata)
...
#         yield PM.ContrabandTypes.from_sde(item, metadata)
...
#     for item, metadata in reader.records(SdeDatasetFiles.CONTROL_TOWER_RESOURCES, file_name):
#         yield PM.ControlTowerResources.from_sde(item, metadata)
...
#     for item, metadata in reader.records(SdeDatasetFiles.CORPORATION_ACTIVITIES, file_name):
#         yield PM.CorporationActivities.from_sde(item, metadata)
...
#         yield PM.DebuffCollections.from_sde(item, metadata)
...
#     for item, metadata in reader.records(SdeDatasetFiles.DOGMA_ATTRIBUTE_CATEGORIES, file_name):
#         yield PM.DogmaAttributeCategories.from_sde(item, metadata)
...
#         yield PM.DogmaAttributes.from_sde(item, metadata)
...
#         yield PM.DogmaEffects.from_sde(item, metadata)
...
#         yield PM.DogmaUnits.from_sde(item, metadata)
...
#     for item, metadata in reader.records(SdeDatasetFiles.DYNAMIC_ITEM_ATTRIBUTES, file_name):
#         yield PM.DynamicItemAttributes.from_sde(item, metadata)
...
#         yield PM.Factions.from_sde(item, metadata)
...
#     data, metadata = reader.record_at(
#         SdeDatasetFiles.FREELANCE_JOB_SCHEMAS, index=1, file_name=file_name
#     )
#     return PM.FreelanceJobSchemas.from_sde(data, metadata)
