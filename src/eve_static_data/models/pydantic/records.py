...
This module contains Pydantic model definitions for individual records in EVE SDE datasets.
...
missing in a given record. In the pydantic models, the field is defined as optional
